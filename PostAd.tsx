    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {!rulesLoading && adPostRules && (
          <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 p-6 rounded-[2rem] flex items-start gap-4 transition-colors">
             <AlertCircle className="w-8 h-8 text-red-500 dark:text-red-400 shrink-0 mt-1" />
             <p className="text-sm md:text-base text-red-800 dark:text-red-200 font-extrabold leading-relaxed whitespace-pre-wrap text-left">
               {adPostRules}
             </p>
          </div>
        )}
