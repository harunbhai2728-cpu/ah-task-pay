...
export function Deposit() {
  ...
  const [depositRules, setDepositRules] = useState('উক্ত নাম্বারে টাকা পাঠিয়ে সেন্ডার নাম্বার, টাকার পরিমান ও ট্রানজেকশন আইডি দিন। ভুয়া রিকোয়েস্ট দিলে একাউন্ট ব্লক করা হবে।');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white dark:bg-slate-800 p-8 md:p-10 rounded-[3rem] border border-gray-100 dark:border-slate-700 shadow-2xl shadow-gray-50 dark:shadow-none space-y-8 transition-colors">
           ...
           <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 p-5 rounded-2xl flex items-start gap-3 transition-colors">
            ...
            <div className="hidden bg-amber-50 border border-amber-200 p-5 rounded-2xl flex items-start gap-3">
             <AlertCircle className="w-6 h-6 text-amber-500 shrink-0 mt-0.5" />
             <p className="text-sm text-amber-800 font-medium leading-relaxed">
               <span className="font-bold uppercase tracking-wider text-xs block mb-1">সতর্কতা:</span>
               অফিশিয়াল নম্বরে টাকা পাঠিয়ে সঠিক TrxID সাবমিট করুন। ভুয়া TrxID বা জালিয়াতির চেষ্টা করলে অ্যাকাউন্ট স্থায়ীভাবে ব্লক হবে। রিভিউ শেষে ব্যালেন্স যোগ হতে ১-৬ ঘণ্টা লাগতে পারে।
             </p>
           </div>
